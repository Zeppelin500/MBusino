...
struct settings {
  ...
  bool haAutodisc;
} userData = { "SSID", "Password", "MBusino", "192.168.1.7", 1883, 5, "mqttUser", "mqttPasword", 5000, 120000, 1, 0xFE, 0, 0, 0, true };

uint8_t mbusAddress[4] = { 0 };
