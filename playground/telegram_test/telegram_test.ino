...
void loop() {
  ...
  if ((loop_start-last_loop)>= MbusInterval || firstrun) { 
    ...
    byte mbus_data[] = {0x68,0x53,0x53,0x68,0x08,0x02,0x72,0x11,0x82,0x00,0x24,0x96,0x15,0x16,0x00,0x20,0x00,0x00,0x00,0x01,0xfd,0x1b,0x00,0x02,0xfc,0x03,0x48,0x52,0x25,0x74,0x62,0x17,0x22,0xfc,0x03,0x48,0x52,0x25,0x74,0x5c,0x17,0x12,0xfc,0x03,0x48,0x52,0x25,0x74,0x68,0x17,0x02,0x65,0xa2,0x08,0x22,0x65,0x9e,0x08,0x12,0x65,0xa2,0x08,0x01,0x72,0x00,0x72,0x65,0x00,0x00,0xb2,0x01,0x65,0x00,0x00,0x0c,0x78,0x11,0x82,0x00,0x24,0x03,0xfd,0x0f,0x05,0x09,0x03,0x1f,0x9f,0x16,0x00};
    ...
    */
    if (mbus_good_frame) {
      ...
      MBusinoLib payload(510);  
      DynamicJsonDocument jsonBuffer(8080);
